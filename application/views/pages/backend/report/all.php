    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo base_url('a/report/pdf') ?>" class="btn btn-danger mb-6">Get PDF</a> &nbsp &nbsp
                        <a href="<?php echo base_url('a/report/excel') ?>" class="btn btn-success mb-6">Get Excel</a>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    foreach ($report as $data) :
                                        $profit = $data->price - $data->purchase;
                                    ?>
                                        <tr>
                                            <td>
                                                <?= $no++ ?>
