                                        ...
                                        foreach ($menus as $menu) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url('admin/menu_controller/update_status/') . $menu->id_menu ?>" class="btn btn-info" onclick="javascript: return confirm('Are you sure item already  ?')"><i class="fas fa-check-circle"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
